...
export const DEFAULT_PORTFOLIO_DATA: PortfolioData = {
  techStack: [
    {
      label: "Tool / Softwares",
      items: ["Slack", "Notion", "Excel", "Figma", "QueensSmile", "QueensPass", "Pitch", "Canva"]
    },
    {
      label: "Process",
      items: ["기획서 작성", "예산 수립", "온-오프라인 운영", "정산 및 사후처리", "스탭 교육 및 관리"]
    },
    {
      label: "Technical",
      items: ["Javascript", "Typescript", "HTML/CSS", "React", "Git", "Python"]
    }
  ],
  featuredProjects: [
    {
  ...
  certificates: [
    ...
    { title: "워드프로세서", subtitle: "단일 등급" },
    { title: "운전면허증", subtitle: "1종보통" }
  ],
  workExperience: [
    {
      company: "퀸즈스마일",
