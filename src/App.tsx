                                        ...
                                        {[0, 1, 2, 3].map((idx) => (
                                          <div key={idx} className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                            ...
                                            <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                              {ticketImages[idx] ? (
                                                <img loading="lazy" src={ticketImages[idx]}
                                                  alt={`snap ${idx + 1}`}
                                                  className="w-full h-full object-cover"
                                                  referrerPolicy="no-referrer"
                                                />
                                    ...
                                    <div className="p-4.5 border border-neutral-200 bg-neutral-50/50 rounded-[12px] space-y-4">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {fnbImages[0] ? (
                                              <img loading="lazy" src={fnbImages[0]}
                                                alt="snap 1"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {fnbImages[1] ? (
                                              <img loading="lazy" src={fnbImages[1]}
                                                alt="snap 2"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {fnbImages[2] ? (
                                              <img loading="lazy" src={fnbImages[2]}
                                                alt="snap 3"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {fnbImages[3] ? (
                                              <img loading="lazy" src={fnbImages[3]}
                                                alt="snap 4"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                    ...
                                    <div className="p-4.5 border border-neutral-200 bg-neutral-50/50 rounded-[12px] space-y-4">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[0] ? (
                                              <img loading="lazy" src={storageImages[0]}
                                                alt="snap 1"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[1] ? (
                                              <img loading="lazy" src={storageImages[1]}
                                                alt="snap 2"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[2] ? (
                                              <img loading="lazy" src={storageImages[2]}
                                                alt="snap 3"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[3] ? (
                                              <img loading="lazy" src={storageImages[3]}
                                                alt="snap 4"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[4] ? (
                                              <img loading="lazy" src={storageImages[4]}
                                                alt="snap 5"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
                                        ...
                                        <div className="p-3 bg-white rounded border border-neutral-250 shadow-4xs flex flex-col gap-2.5">
                                          ...
                                          <div className="relative aspect-[16/9] w-full overflow-hidden bg-neutral-50 rounded border border-neutral-200 flex items-center justify-center shrink-0">
                                            {storageImages[5] ? (
                                              <img loading="lazy" src={storageImages[5]}
                                                alt="snap 6"
                                                className="w-full h-full object-cover"
                                                referrerPolicy="no-referrer"
                                              />
